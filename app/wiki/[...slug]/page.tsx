...
async function getPost({ slug }: { slug: string[] }) {
  ...
  const possiblePaths = [`${relativeBasePath}.mdx`, `${relativeBasePath}/index.mdx`];
              ...
              <Card className="bg-gradient-to-br from-primary/5 to-blue-400/5 border-primary/20">
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground mb-4">
                    Help make our documentation better by contributing to this page.
                  </p>
                  <div className="space-y-2">
                    <Button asChild size="sm" className="w-full" variant="outline">
                      <Link href={gitlabEditUrl} target="_blank" rel="noopener noreferrer">
                ...
                <CardContent className="space-y-3">
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div className="text-xs text-muted-foreground">Get real-time help</div>
                    </div>
                  </Link>
                  <Link
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div className="text-xs text-muted-foreground">Common solutions</div>
                    </div>
                  </Link>
                </CardContent>
              </Card>
